...
namespace PublishToNuget.Tools
{
    public class NuGetPublish
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private NuGetPublish(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new NuGetPublish(package, commandService);
        }
