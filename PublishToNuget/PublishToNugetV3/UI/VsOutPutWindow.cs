...
namespace PublishToNugetV3.UI
{
    internal class VsOutPutWindow
    {
        public static void CreatePane(Guid paneGuid, string title, bool visible, bool clearWithSolution)
        {
            Microsoft.VisualStudio.Shell.ThreadHelper.ThrowIfNotOnUIThread();
            IAsyncServiceProvider provider = VsProjectHelper.GetGlobalService(GuidString.PackageGuidString);
        ...
        public static async void CreatePane(string title, string content)
        {
            ...
            DTE2 dte = (DTE2)await VsProjectHelper.GetGlobalService(GuidString.PackageGuidString).GetServiceAsync(typeof(DTE));
